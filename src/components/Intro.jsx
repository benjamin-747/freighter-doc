  ...
  return (
    <>
      ...
      <h1 className="mt-14 font-display text-4xl/tight font-light text-white">
        Freighter - {' '}
        <span className="text-sky-300">Rust代理和镜像</span>
      </h1>
      <p className="mt-4 text-sm/6 text-gray-300">
        Freighter的目的是帮助社区和公司构建crates.io的代理和开发环境的镜像。
      </p>
      <SignUpForm />
      <div className="mt-8 flex flex-wrap justify-center gap-x-1 gap-y-3 sm:gap-x-2 lg:justify-start">
        <IconLink href="https://rust-lang.nju.edu.cn/document" icon={BookIcon} className="flex-none">
          文档
        </IconLink>
        <IconLink href="https://github.com/open-rust-initiative/freighter" icon={GitHubIcon} className="flex-none">
          GitHub
        </IconLink>
      </div>
    </>
...
export function IntroFooter() {
  return (
    <p className="flex items-baseline gap-x-2 text-[0.8125rem]/6 text-gray-500">
      Brought to you by{' '}
      <IconLink href="https://twitter.com/genedna" icon={TwitterIcon} compact large>
        genedna
      </IconLink>
    </p>
  )
